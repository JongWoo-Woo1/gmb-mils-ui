...
- commit: 755f4ae  (branch: main)
- generated: 2025-10-29 00:27:37
...
### src\styles\rail.css
```css
/* 내부 레일: 메인뷰 내부 좌우 여백을 만들고, UI는 1600×1000로 고정 */
:root {
  --rail-w: 1600px;
} /* ← 1520/1600/1600 등으로 바꿔도 됨 */
...
.lv-rail {
  ...
  height: 1000px;
  margin-left: auto;
  margin-right: auto; /* 메인뷰 안에서 중앙 정렬 */
  position: relative;
  /* 디버그용 테두리(필요시 해제)
  outline: 0px dashed #e5e7eb;
  */
}
